...
public:
    ...
    bool LineTriangleIntersection(const Eigen::Matrix<T, 3, 1>& origPos, const Eigen::Matrix<T, 3, 1>& newPos,
                                  std::shared_ptr<Mesh> standingMesh, Intersection *isect, float dt);
};
