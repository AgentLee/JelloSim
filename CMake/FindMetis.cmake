...
endif (METIS_INCLUDE_DIRS AND METIS_LIBRARIES)
...
macro(_metis_check_version)
  file(READ "${METIS_INCLUDE_DIRS}/metis.h" _metis_version_header)
  ...
  if(NOT METIS_VERSION_OK)
    message(STATUS "Metis version ${METIS_VERSION} found in ${METIS_INCLUDE_DIRS}, "
                   "but at least version ${Metis_FIND_VERSION} is required")
  endif(NOT METIS_VERSION_OK)
endmacro(_metis_check_version)

  if(METIS_INCLUDE_DIRS AND Metis_FIND_VERSION)
...
find_package_handle_standard_args(METIS DEFAULT_MSG
                                  METIS_INCLUDE_DIRS METIS_LIBRARIES METIS_VERSION_OK)

mark_as_advanced(METIS_INCLUDE_DIRS METIS_LIBRARIES)
list(REMOVE_ITEM METIS_INCLUDE_DIRS /usr/include)
