...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref v1.1.0
  WORKING_DIRECTORY "D:/Documents/Github/JelloSim/cmake-build-debug/partio-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v1.1.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v1.1.0")
...
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 v1.1.0
  WORKING_DIRECTORY "D:/Documents/Github/JelloSim/cmake-build-debug/partio-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/wdas/partio.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Documents/Github/JelloSim/cmake-build-debug/partio-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Documents/Github/JelloSim/cmake-build-debug/partio-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
